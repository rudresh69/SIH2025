...
- Weather conditions monitoring with risk assessment
- Image model for visual detection of rockfall events
- ML prediction models for risk assessment
- Final risk indicator with traffic light system
- Event log for tracking system updates
- Alert simulation button for demonstration purposes
